...
}estacion_t;							//	tama�o: 24 caracteres
...
typedef struct
{
	...
	uint8				sensorHab2;		//	22
	uint8				sensorHab3;		//	23
}trama_inicio_t;						//	tama�o: 24 caracteres
...
typedef struct
{
	...
	uint8				sensorHab2;		//	13
	uint8				sensorHab3;		//	14
}trama_config_t;						//	tama�o: 15 caracteres
...
}server_t;								//	32 bytes de tama�o de variable
