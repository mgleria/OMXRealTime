...
//                    printf("case SYNCHRONOUS:");
                    syncCounter++;
                    //Para cada medici�n sincr�nica debe definirse un acumulador
...
/////////////////////MUESTRAS TOMADAS ASINCRONICAMENTE//////////////////////////
            //to-do: Hacer una funci�n que me permita escalar esto mejor
...
//Funci�n de transferencia del sensor TC1047A embebido en Explorer16/32
uint16_t getTemperature(uint16_t adcValue){
    // VOUT = (10 mV/�C) (Temperature �C) + 500 mV
    // 3300mV/1024*ADC=(10mV/�C)*(T�C)+500mV 
    uint16_t temp = (adcValue*165/512)-50;
    return temp;
}

uint16_t getAccumulatedRain(){
    /*Se est� usando el contador provisto por el driver de TMR3 ya que no se 
