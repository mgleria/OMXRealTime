...
${OBJECTDIR}/Source/traceRecorder/trcKernelPort.o: Source/traceRecorder/trcKernelPort.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Source/traceRecorder" 
	@${RM} ${OBJECTDIR}/Source/traceRecorder/trcKernelPort.o.d 
	@${RM} ${OBJECTDIR}/Source/traceRecorder/trcKernelPort.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Source/traceRecorder/trcKernelPort.c  -o ${OBJECTDIR}/Source/traceRecorder/trcKernelPort.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Source/traceRecorder/trcKernelPort.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -D__OMX_S__ -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"include" -I"include/freeRTOS" -I"mcc_generated_files" -I"../../Program Files (x86)/Percepio/Tracealyzer for FreeRTOS/TraceRecorder/include" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/Source/traceRecorder/trcKernelPort.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/Source/traceRecorder/trcSnapshotRecorder.o: Source/traceRecorder/trcSnapshotRecorder.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Source/traceRecorder" 
	@${RM} ${OBJECTDIR}/Source/traceRecorder/trcSnapshotRecorder.o.d 
	@${RM} ${OBJECTDIR}/Source/traceRecorder/trcSnapshotRecorder.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Source/traceRecorder/trcSnapshotRecorder.c  -o ${OBJECTDIR}/Source/traceRecorder/trcSnapshotRecorder.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Source/traceRecorder/trcSnapshotRecorder.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -D__OMX_S__ -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"include" -I"include/freeRTOS" -I"mcc_generated_files" -I"../../Program Files (x86)/Percepio/Tracealyzer for FreeRTOS/TraceRecorder/include" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/Source/traceRecorder/trcSnapshotRecorder.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/Source/traceRecorder/trcStreamingRecorder.o: Source/traceRecorder/trcStreamingRecorder.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Source/traceRecorder" 
	@${RM} ${OBJECTDIR}/Source/traceRecorder/trcStreamingRecorder.o.d 
	@${RM} ${OBJECTDIR}/Source/traceRecorder/trcStreamingRecorder.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Source/traceRecorder/trcStreamingRecorder.c  -o ${OBJECTDIR}/Source/traceRecorder/trcStreamingRecorder.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Source/traceRecorder/trcStreamingRecorder.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -D__OMX_S__ -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"include" -I"include/freeRTOS" -I"mcc_generated_files" -I"../../Program Files (x86)/Percepio/Tracealyzer for FreeRTOS/TraceRecorder/include" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/Source/traceRecorder/trcStreamingRecorder.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
